...
#[CoversClass(UserActivatedEvent::class)]
final class UserActivatedEventTest extends TestCase
{
    ...
    {
        $event = new UserActivatedEvent($this->userId, $this->email, $this->name);
    ...
    public function testGetAggregateType(): void
    {
        ...
        self::assertSame('user.activated', $event->getAggregateType());
    }
